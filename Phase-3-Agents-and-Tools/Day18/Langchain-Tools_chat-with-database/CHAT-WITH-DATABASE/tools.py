...
def list_tables() -> str:
    """
    Call this FIRST to see what tables exist in the database.
    Returns the table names as one comma-separated string.
    """
...
def describe_table(table_name: str) -> str:
    """
    Call this BEFORE writing SQL so it uses the real column names and types.
    """
    try:
...
def run_sql_query(query: str) -> str:
    ...
    Check the schema with describe_table first.
